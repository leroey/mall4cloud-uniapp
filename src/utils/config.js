...
var domain = 'http://47.96.20.186:8000' // 统一接口域名，测试环境
// var domain = 'http://sharerare.store:8000' // 统一接口域名，测试环境
var wsDomain = 'ws://47.96.20.186:8000' // 统一接口域名，测试环境
// var wsDomain = 'ws://sharerare.store:8000' // 统一接口域名，测试环境

var picDomain = 'http://img-test.gz-yami.com/' // 图片域名

// 访问文件存储资源的url 对应阿里云的Bucket域名
var resourcesUrl = 'http://47.96.20.186:9000/mall4cloud'
// var resourcesUrl = 'http://sharerare.store:9000/mall4cloud'
